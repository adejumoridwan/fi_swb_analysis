...
```{r}
columns_to_exclude = c("HH1", "HH2", "wmweight", "PSU", "stratum", "HHAGE","HH48")
...
fit <- brm(SWB ~ FI + welevel + WEU + WFS + WFA + WAGE + (1|HOE) + (1|AFIP) + (1|UFIP) +(1|zone) + + (1|zone) + (1|HHSEX) + (1|helevel) + (1|insurance), 
           data = mics, chains = 1, iter =  500)
```
